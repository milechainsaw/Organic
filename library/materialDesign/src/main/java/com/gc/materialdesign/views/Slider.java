...
public class Slider extends CustomView {
    ...
    boolean showJustBubbleIndicator = false;

    public void setShowJustBubbleIndicator(boolean v) {
        showJustBubbleIndicator = v;
    }

    boolean showNumberIndicator = true;
    boolean press = false;
